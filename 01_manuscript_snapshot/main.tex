...
\vtop{\hsize=0.31\textwidth\centering\baselineskip=13pt\sublargesize Usharani Hareesh Govindarajan$^{1}$\par\baselineskip=11pt\normalsize Business School\par University of Shanghai for\par Science and Technology\par Shanghai, China\par}%
\hspace{0.035\textwidth}%
\vtop{\hsize=0.31\textwidth\centering\baselineskip=13pt\sublargesize Zhengyu Tang$^{2*}$\par\baselineskip=11pt\normalsize Harbin Institute of Technology\par Harbin, China\par 2024111771@stu.hit.edu.cn\par}%
\hspace{0.035\textwidth}%
\vtop{\hsize=0.31\textwidth\centering\baselineskip=13pt\sublargesize Sungjoo Lee$^{3}$\par\baselineskip=11pt\normalsize Seoul National University\par Seoul, South Korea\par}%
\linebreakand
\vtop{\hsize=0.31\textwidth\centering\baselineskip=13pt\sublargesize Arash Hajikhani$^{4}$\par\baselineskip=11pt\normalsize VTT Technical Research\par Centre of Finland\par Espoo, Finland\par}%
\hspace{0.035\textwidth}%
\vtop{\hsize=0.31\textwidth\centering\baselineskip=13pt\sublargesize Gagan Narang$^{5}$\par\baselineskip=11pt\normalsize Department of Information Engineering\par Universit\`a Politecnica delle Marche\par Ancona, Italy\par}%
\hspace{0.035\textwidth}%
\vtop{\hsize=0.31\textwidth\centering\baselineskip=13pt\sublargesize Raphael Loridan$^{6}$\par\baselineskip=11pt\normalsize OYMotion Technologies\par Co., Ltd.\par Shanghai, China\par}%
\linebreakand
\hspace*{0.345\textwidth}%
\vtop{\hsize=0.31\textwidth\centering\baselineskip=13pt\sublargesize Adriano Mancini$^{7}$\par\baselineskip=11pt\normalsize Department of Information Engineering\par Universit\`a Politecnica delle Marche\par Ancona, Italy\par}%
}
...
\newcommand{\reprourl}{%
  ...
  \else
    \url{https://github.com/Tangzy0121/asimov-cascade-reproducibility}%
  \fi
}
...
\else
This research is supported by the National Natural Science Foundation of China (NSFC) under Grant No. W2433177.
\fi
